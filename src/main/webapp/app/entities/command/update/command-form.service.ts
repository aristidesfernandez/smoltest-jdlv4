...
type CommandFormGroupContent = {
  ...
  description: FormControl<ICommand['description']>;
  processor: FormControl<ICommand['processor']>;
};
...
export class CommandFormService {
  createCommandFormGroup(command: CommandFormGroupInput = { id: null }): CommandFormGroup {
    ...
    return new FormGroup<CommandFormGroupContent>({
      ...
      description: new FormControl(commandRawValue.description, {
        validators: [Validators.maxLength(100)],
      }),
      processor: new FormControl(commandRawValue.processor, {
        validators: [Validators.maxLength(100)],
      }),
    });
  }
