...
import { EntityArrayResponseType, CurrencyTypeService } from '../service/currency-type.service';
...
export class CurrencyTypeComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICurrencyType): number => this.currencyTypeService.getCurrencyTypeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.currencyTypes = dataFromBody;
  }
