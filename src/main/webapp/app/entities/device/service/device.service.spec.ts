...
const requireRestSample: RestDevice = {
  ...
  fabricationDate: sampleWithRequiredData.fabricationDate?.format(DATE_FORMAT),
  endLostCommunication: sampleWithRequiredData.endLostCommunication?.toJSON(),
  startLostCommunication: sampleWithRequiredData.startLostCommunication?.toJSON(),
  lastUpdateDate: sampleWithRequiredData.lastUpdateDate?.toJSON(),
  lastCorruptionDate: sampleWithRequiredData.lastCorruptionDate?.toJSON(),
};
