...
describe('DeviceType routing resolve service', () => {
  ...
  let resultDeviceType: IDeviceType | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IDeviceType returned by find', () => {
      ...
      expect(resultDeviceType).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultDeviceType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IDeviceType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
