...
describe('DeviceType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'device-type', component: DeviceTypeComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to deviceTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDeviceTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDeviceTypeIdentifier).toHaveBeenCalledWith(entity);
