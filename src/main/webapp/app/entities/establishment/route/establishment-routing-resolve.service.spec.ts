...
describe('Establishment routing resolve service', () => {
  ...
  let resultEstablishment: IEstablishment | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEstablishment).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEstablishment>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
