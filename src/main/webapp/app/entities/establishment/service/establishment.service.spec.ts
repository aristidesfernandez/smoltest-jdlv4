...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../establishment.test-samples';

import { EstablishmentService, RestEstablishment } from './establishment.service';

const requireRestSample: RestEstablishment = {
  ...sampleWithRequiredData,
  liquidationTime: sampleWithRequiredData.liquidationTime?.toJSON(),
  startTime: sampleWithRequiredData.startTime?.toJSON(),
  closeTime: sampleWithRequiredData.closeTime?.toJSON(),
};
...
describe('Establishment Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Establishment', () => {
      ...
      const establishment = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(establishment).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Establishment', () => {
      const establishment = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(establishment).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addEstablishmentToCollectionIfMissing', () => {
      it('should add a Establishment to an empty array', () => {
        const establishment: IEstablishment = sampleWithRequiredData;
      ...
      it("should add a Establishment to an array that doesn't contain it", () => {
        const establishment: IEstablishment = sampleWithRequiredData;
        const establishmentCollection: IEstablishment[] = [sampleWithPartialData];
        expectedResult = service.addEstablishmentToCollectionIfMissing(establishmentCollection, establishment);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(establishment);
      });
      ...
      it('should add only unique Establishment to an array', () => {
        const establishmentArray: IEstablishment[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const establishmentCollection: IEstablishment[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const establishment: IEstablishment = sampleWithRequiredData;
        const establishment2: IEstablishment = sampleWithPartialData;
    ...
    describe('compareEstablishment', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareEstablishment(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareEstablishment(entity1, entity2);
        const compareResult2 = service.compareEstablishment(entity2, entity1);
