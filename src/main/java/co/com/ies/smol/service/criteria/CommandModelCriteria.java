...
public class CommandModelCriteria implements Serializable, Criteria {
    ...
    public CommandModelCriteria(CommandModelCriteria other) {
        ...
        this.codeSAS = other.codeSAS == null ? null : other.codeSAS.copy();
    ...
    public StringFilter getCodeSAS() {
        return codeSAS;
    }

    public StringFilter codeSAS() {
        if (codeSAS == null) {
            codeSAS = new StringFilter();
        }
        return codeSAS;
    }

    public void setCodeSAS(StringFilter codeSAS) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(codeSAS, that.codeSAS) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, codeSAS, commandId, modelId, distinct);
    }
