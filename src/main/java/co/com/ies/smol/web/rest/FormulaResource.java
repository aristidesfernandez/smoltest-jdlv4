...
import co.com.ies.smol.service.FormulaQueryService;
...
/**
 * REST controller for managing {@link co.com.ies.smol.domain.Formula}.
 */
@RestController
@RequestMapping("/api")
public class FormulaResource {
    ...
    public ResponseEntity<FormulaDTO> updateFormula(
        ...
        FormulaDTO result = formulaService.update(formulaDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<FormulaDTO>> getAllFormulas(
        ...
        Page<FormulaDTO> page = formulaQueryService.findByCriteria(criteria, pageable);
