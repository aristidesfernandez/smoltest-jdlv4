...
class CommandModelResourceIT {
    ...
    private static final String DEFAULT_CODE_SAS = "AA";
    private static final String UPDATED_CODE_SAS = "BB";
    ...
    public static CommandModel createEntity(EntityManager em) {
        CommandModel commandModel = new CommandModel().codeSAS(DEFAULT_CODE_SAS);
        // Add required entity
        Command command;
    ...
    public static CommandModel createUpdatedEntity(EntityManager em) {
        CommandModel commandModel = new CommandModel().codeSAS(UPDATED_CODE_SAS);
        // Add required entity
        Command command;
        if (TestUtil.findAll(em, Command.class).isEmpty()) {
    ...
    void createCommandModel() throws Exception {
        ...
        assertThat(testCommandModel.getCodeSAS()).isEqualTo(DEFAULT_CODE_SAS);
    }
    ...
    void getAllCommandModels() throws Exception {
        ...
        restCommandModelMockMvc
            ...
            .andExpect(jsonPath("$.[*].codeSAS").value(hasItem(DEFAULT_CODE_SAS)));
    }
    ...
    void getCommandModel() throws Exception {
        ...
        restCommandModelMockMvc
            ...
            .andExpect(jsonPath("$.codeSAS").value(DEFAULT_CODE_SAS));
    }
    ...
    @Test
    @Transactional
    void getAllCommandModelsByCodeSASIsEqualToSomething() throws Exception {
        // Initialize the database
        commandModelRepository.saveAndFlush(commandModel);

        // Get all the commandModelList where codeSAS equals to DEFAULT_CODE_SAS
        defaultCommandModelShouldBeFound("codeSAS.equals=" + DEFAULT_CODE_SAS);

        // Get all the commandModelList where codeSAS equals to UPDATED_CODE_SAS
        defaultCommandModelShouldNotBeFound("codeSAS.equals=" + UPDATED_CODE_SAS);
    }

    @Test
    @Transactional
    void getAllCommandModelsByCodeSASIsInShouldWork() throws Exception {
        // Initialize the database
        commandModelRepository.saveAndFlush(commandModel);

        // Get all the commandModelList where codeSAS in DEFAULT_CODE_SAS or UPDATED_CODE_SAS
        defaultCommandModelShouldBeFound("codeSAS.in=" + DEFAULT_CODE_SAS + "," + UPDATED_CODE_SAS);

        // Get all the commandModelList where codeSAS equals to UPDATED_CODE_SAS
        defaultCommandModelShouldNotBeFound("codeSAS.in=" + UPDATED_CODE_SAS);
    }

    @Test
    @Transactional
    void getAllCommandModelsByCodeSASIsNullOrNotNull() throws Exception {
        // Initialize the database
        commandModelRepository.saveAndFlush(commandModel);

        // Get all the commandModelList where codeSAS is not null
        defaultCommandModelShouldBeFound("codeSAS.specified=true");

        // Get all the commandModelList where codeSAS is null
        defaultCommandModelShouldNotBeFound("codeSAS.specified=false");
    }

    @Test
    @Transactional
    void getAllCommandModelsByCodeSASContainsSomething() throws Exception {
        // Initialize the database
        commandModelRepository.saveAndFlush(commandModel);

        // Get all the commandModelList where codeSAS contains DEFAULT_CODE_SAS
        defaultCommandModelShouldBeFound("codeSAS.contains=" + DEFAULT_CODE_SAS);

        // Get all the commandModelList where codeSAS contains UPDATED_CODE_SAS
        defaultCommandModelShouldNotBeFound("codeSAS.contains=" + UPDATED_CODE_SAS);
    }

    @Test
    @Transactional
    void getAllCommandModelsByCodeSASNotContainsSomething() throws Exception {
        // Initialize the database
        commandModelRepository.saveAndFlush(commandModel);

        // Get all the commandModelList where codeSAS does not contain DEFAULT_CODE_SAS
        defaultCommandModelShouldNotBeFound("codeSAS.doesNotContain=" + DEFAULT_CODE_SAS);

        // Get all the commandModelList where codeSAS does not contain UPDATED_CODE_SAS
        defaultCommandModelShouldBeFound("codeSAS.doesNotContain=" + UPDATED_CODE_SAS);
    }
    ...
    void putExistingCommandModel() throws Exception {
        ...
        updatedCommandModel.codeSAS(UPDATED_CODE_SAS);
        ...
        CommandModel testCommandModel = commandModelList.get(commandModelList.size() - 1);
        assertThat(testCommandModel.getCodeSAS()).isEqualTo(UPDATED_CODE_SAS);
    }
    ...
    void partialUpdateCommandModelWithPatch() throws Exception {
        ...
        partialUpdatedCommandModel.codeSAS(UPDATED_CODE_SAS);
