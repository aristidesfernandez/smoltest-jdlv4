...
class CommandResourceIT {
    ...
    public static Command createEntity(EntityManager em) {
        Command command = new Command().code(DEFAULT_CODE).description(DEFAULT_DESCRIPTION).processor(DEFAULT_PROCESSOR);
        return command;
    }
    ...
    public static Command createUpdatedEntity(EntityManager em) {
        Command command = new Command().code(UPDATED_CODE).description(UPDATED_DESCRIPTION).processor(UPDATED_PROCESSOR);
        return command;
    }
    ...
    void createCommand() throws Exception {
        ...
        assertThat(testCommand.getProcessor()).isEqualTo(DEFAULT_PROCESSOR);
    }
    ...
    @Test
    @Transactional
    void getAllCommandsByDescriptionIsEqualToSomething() throws Exception {
        // Initialize the database
        commandRepository.saveAndFlush(command);

        // Get all the commandList where description equals to DEFAULT_DESCRIPTION
        defaultCommandShouldBeFound("description.equals=" + DEFAULT_DESCRIPTION);

        // Get all the commandList where description equals to UPDATED_DESCRIPTION
        defaultCommandShouldNotBeFound("description.equals=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllCommandsByDescriptionIsInShouldWork() throws Exception {
        // Initialize the database
        commandRepository.saveAndFlush(command);

        // Get all the commandList where description in DEFAULT_DESCRIPTION or UPDATED_DESCRIPTION
        defaultCommandShouldBeFound("description.in=" + DEFAULT_DESCRIPTION + "," + UPDATED_DESCRIPTION);

        // Get all the commandList where description equals to UPDATED_DESCRIPTION
        defaultCommandShouldNotBeFound("description.in=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllCommandsByDescriptionIsNullOrNotNull() throws Exception {
        // Initialize the database
        commandRepository.saveAndFlush(command);

        // Get all the commandList where description is not null
        defaultCommandShouldBeFound("description.specified=true");

        // Get all the commandList where description is null
        defaultCommandShouldNotBeFound("description.specified=false");
    }

    @Test
    @Transactional
    void getAllCommandsByDescriptionContainsSomething() throws Exception {
        // Initialize the database
        commandRepository.saveAndFlush(command);

        // Get all the commandList where description contains DEFAULT_DESCRIPTION
        defaultCommandShouldBeFound("description.contains=" + DEFAULT_DESCRIPTION);

        // Get all the commandList where description contains UPDATED_DESCRIPTION
        defaultCommandShouldNotBeFound("description.contains=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllCommandsByDescriptionNotContainsSomething() throws Exception {
        // Initialize the database
        commandRepository.saveAndFlush(command);

        // Get all the commandList where description does not contain DEFAULT_DESCRIPTION
        defaultCommandShouldNotBeFound("description.doesNotContain=" + DEFAULT_DESCRIPTION);

        // Get all the commandList where description does not contain UPDATED_DESCRIPTION
        defaultCommandShouldBeFound("description.doesNotContain=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllCommandsByProcessorIsEqualToSomething() throws Exception {
        // Initialize the database
        commandRepository.saveAndFlush(command);

        // Get all the commandList where processor equals to DEFAULT_PROCESSOR
        defaultCommandShouldBeFound("processor.equals=" + DEFAULT_PROCESSOR);

        // Get all the commandList where processor equals to UPDATED_PROCESSOR
        defaultCommandShouldNotBeFound("processor.equals=" + UPDATED_PROCESSOR);
    }

    @Test
    @Transactional
    void getAllCommandsByProcessorIsInShouldWork() throws Exception {
        // Initialize the database
        commandRepository.saveAndFlush(command);

        // Get all the commandList where processor in DEFAULT_PROCESSOR or UPDATED_PROCESSOR
        defaultCommandShouldBeFound("processor.in=" + DEFAULT_PROCESSOR + "," + UPDATED_PROCESSOR);

        // Get all the commandList where processor equals to UPDATED_PROCESSOR
        defaultCommandShouldNotBeFound("processor.in=" + UPDATED_PROCESSOR);
    }

    @Test
    @Transactional
    void getAllCommandsByProcessorIsNullOrNotNull() throws Exception {
        // Initialize the database
        commandRepository.saveAndFlush(command);

        // Get all the commandList where processor is not null
        defaultCommandShouldBeFound("processor.specified=true");

        // Get all the commandList where processor is null
        defaultCommandShouldNotBeFound("processor.specified=false");
    }

    @Test
    @Transactional
    void getAllCommandsByProcessorContainsSomething() throws Exception {
        // Initialize the database
        commandRepository.saveAndFlush(command);

        // Get all the commandList where processor contains DEFAULT_PROCESSOR
        defaultCommandShouldBeFound("processor.contains=" + DEFAULT_PROCESSOR);

        // Get all the commandList where processor contains UPDATED_PROCESSOR
        defaultCommandShouldNotBeFound("processor.contains=" + UPDATED_PROCESSOR);
    }

    @Test
    @Transactional
    void getAllCommandsByProcessorNotContainsSomething() throws Exception {
        // Initialize the database
        commandRepository.saveAndFlush(command);

        // Get all the commandList where processor does not contain DEFAULT_PROCESSOR
        defaultCommandShouldNotBeFound("processor.doesNotContain=" + DEFAULT_PROCESSOR);

        // Get all the commandList where processor does not contain UPDATED_PROCESSOR
        defaultCommandShouldBeFound("processor.doesNotContain=" + UPDATED_PROCESSOR);
    }
    ...
    void putExistingCommand() throws Exception {
        ...
        updatedCommand.code(UPDATED_CODE).description(UPDATED_DESCRIPTION).processor(UPDATED_PROCESSOR);
        ...
        assertThat(testCommand.getProcessor()).isEqualTo(UPDATED_PROCESSOR);
    }
    ...
    void partialUpdateCommandWithPatch() throws Exception {
        ...
        partialUpdatedCommand.code(UPDATED_CODE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateCommandWithPatch() throws Exception {
        ...
        partialUpdatedCommand.code(UPDATED_CODE).description(UPDATED_DESCRIPTION).processor(UPDATED_PROCESSOR);
